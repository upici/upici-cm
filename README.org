...
1. [[file:exemples_python/intro_numpy.html][intro_numpy.html]] : introduction à Numpy sous forme de page web. Le
   code python est dans [[file:exemples_python/intro_numpy.py][intro_numpy.py]].
